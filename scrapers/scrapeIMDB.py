...
AtlanticIMDB_URLs = ['https://imdb.com/search/title/?companies=co0146284',
            'https://imdb.com/search/title/?companies=co0146284&start=51&ref_=adv_nxt'
            ]
...
#x = getIMDB_Dirrectors(AtlanticIMDB_URLs[0])


for i in AtlanticIMDB_URLs:
