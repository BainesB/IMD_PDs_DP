...
# removed the '  ' doubles space on the front
# find-replaced the ' ",' with '",' on the end of each line. 

List_of_titles = [

	#"1969",
	#"Wild Thing",
	#"Apollo 11: The Untold Story", No PM
	...
	#"Apollo 13: The Inside Story", # no PM
	#"The Conquistadors", no PM
	#"Legend of the Holy Spear", # no PM
	#"Hannibal v Rome", # no PM
	#"Dream a Dream: Charlotte Church in the Holy Land", # no PM
	#"The Link", # no PM 
	#"Khubilai Khan: Fall of the Mongol Hordes", # no PM 
